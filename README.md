...
按照 [Issue 模板](https://github.com/327261086/friends/issues/new/choose) 内容填写并提交，当条件均达成后，博主会通过审核，通过后稍等片刻即可在友链页面看到您的友链。
...
description: 不要轻言放弃，否则就对不起自己
feed: https://orgv.de/atom.xml
```
